...
public class SimpleMonthAdapter extends BaseAdapter implements SimpleMonthView.OnDayClickListener {
    ...
    public int getCount() {
        return mController.getTotalNumberOFMonthsToBeDisplayed();
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView != null) {
            ...
            v = new SimpleMonthView(mContext, mController);
        ...
        final int month = (mController.getMinDateMonth() + position) % MONTHS_IN_YEAR;
        final int year = (mController.getMinDateMonth() + position) / MONTHS_IN_YEAR + mController.getMinYear();
...
//        v.invalidate();
    ...
    protected void onDayTapped(CalendarDay calendarDay) {
        ...
        if (Utils.checkValidDay(calendarDay, mController)) {
