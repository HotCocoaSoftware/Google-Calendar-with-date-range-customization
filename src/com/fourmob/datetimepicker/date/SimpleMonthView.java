...
public class SimpleMonthView extends View {
    ...
    private final DatePickerController datePickerController;
    ...
    protected int mInvalidDayTextColor;
    ...
    public SimpleMonthView(Context context,DatePickerController datePickerController) {
        ...
        mInvalidDayTextColor = resources.getColor(R.color.done_text_color_disabled);
		mTodayNumberColor = resources.getColor(R.color.new_color);
	...
	protected void drawMonthNums(Canvas canvas) {
		...
		while (day <= mNumCells) {
            ...
            if (mHasToday && (mToday == day)) {
                ...
                SimpleMonthAdapter.CalendarDay calendarDay = new SimpleMonthAdapter.CalendarDay(mCalendar);
                calendarDay.setDay(mYear,mMonth,day);
                if(Utils.checkValidDay(calendarDay,datePickerController)) {
                    mMonthNumPaint.setColor(mDayTextColor);
                }else{
                    mMonthNumPaint.setColor(mInvalidDayTextColor);
                }
            }
